...
--
-- Name: Customer Customer_subject_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Customer"
    ADD CONSTRAINT "Customer_subject_key" UNIQUE (subject);
...
--
-- Name: OrderItem unique_order_product; Type: CONSTRAINT; Schema: public; Owner: postgres
--
